...
- pkg-config (for p8est via MacPorts)
...
- p4est/p8est + libsc (MacPorts): ``sudo port install p4est``
...
- p8est: ``export PKG_CONFIG_PATH=/opt/local/lib/pkgconfig:$PKG_CONFIG_PATH``
